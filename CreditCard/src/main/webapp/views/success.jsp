...
<div class="container-fluid" style='background-color: #0066ff;'>
	...
	<h3   style=" margin-top : 160px; text-align : center">
	
	     We got your Details, You will receive mail with in 2 days with status. 
	...
	<footer style=" background-color:#d3d3d3;  margin-top : 220px; ">
