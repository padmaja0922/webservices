...
<body>
		...
		<div class="row">
			...
			<div class="col-sm-10">
				<div class="btn-group btn-group-justified"
					...
					<a href="#" class="btn btn-primary">Home</a> <a href="index"
						class="btn btn-primary">Credit cards</a> <a href="#"
						class="btn btn-primary">lending </a> <a href="#"
						class="btn btn-primary">Banking</a> <a href="#"
	...
	<h3 style="margin-top: 80px; text-align: center">Your card is already activated 
	  Please go to home page to Login.
		</h3>
	...
	<footer style=" background-color:#d3d3d3;  margin-top : 80px; ">
